...
function showBoats() {
  if (boats.length > 0) {
    ...
    //if collision happened with our tower with our pirate ship

  // that means collision.collided is true

  //and our boat is not broken that means 
  //isBroken=false


  //so if (collision.collided is true  and the boat is not broken so
      //    boats[i]----->this means any boat in array boats is not broken
